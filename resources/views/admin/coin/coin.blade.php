                    ...
                    <table class="table text-nowrap align-middle mb-0 table-hover">
                        <thead>
                            <tr class="border-2 border-bottom border-primary border-0">
                                ...
                                <th scope="col" class="text-center">사용 여부 / <br>마이닝 여부</th>
                                <th scope="col" class="text-center">자산 여부 / <br>수익 여부</th>
                        ...
                        <tbody class="table-group-divider">
                            ...
                            <tr>
                                <th scope="row" class="ps-0 fw-medium text-center" rowspan="2">{{ $list->firstItem() + $key }}</th>
                                <td class="text-center" rowspan="2">{{ $value->code }}</td>
                                <td class="text-center" rowspan="2">{{ $value->name }}</td>
                                <td class="text-center" rowspan="2">
                                    <div class="d-flex">
                                        <input type="text" name="address[{{ $value->id }}]" value="{{ $value->address }}" class="form-control me-2">
                                    </div>
                                </td>
                                ...
                                <td class="text-center" rowspan="2">{{ $value->created_at }}</td>
                                <td rowspan="2"><button type="button" class="btn btn-sm btn-danger updateBtn" data-id="{{ $value->id }}">수정</button></td>
                            </tr>
                            <tr>
                                <td class="text-center">
                                    <div class="d-flex">
