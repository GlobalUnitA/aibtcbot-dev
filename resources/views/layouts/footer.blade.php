           ...
           @if(auth()->user()->member->is_referral == 'y')
            ...
            <div class="col px-1">
                <a href="{{ route('home') }}" class="text-decoration-none text-dark">
                    <img src="{{ asset('/images/icon/nav_menu_home.svg') }}" class="pb-1 m-home">
                    <div class="fs-3">{{ __('layout.home') }}</div>
                </a>
            </div>
            <div class="col px-1">
                <a href="{{ route('profile.dashboard') }}" class="text-decoration-none text-dark">
                    <img src="{{ asset('/images/icon/nav_menu_dashboard.svg') }}" class="pb-1 m-dashboard">
            ...
            <div class="col px-1">
                ...
                <a href="#" class="text-decoration-none text-dark" onclick="alertModal('{{ __('system.coming_soon_notice') }}')">
                    <img src="{{ asset('/images/icon/nav_menu_terms.svg') }}" class="pb-1 m-terms">
